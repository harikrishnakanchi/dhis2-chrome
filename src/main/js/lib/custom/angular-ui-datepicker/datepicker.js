...
.directive('datepicker', function() {
    return {
        restrict: 'EA',
        replace: true,
        templateUrl: 'js/lib/custom/angular-ui-datepicker/datepicker.html',
        scope: {
            datepickerMode: '=?',
            dateDisabled: '&'
        },
...
.directive('daypicker', ['dateFilter',
    function(dateFilter) {
        return {
            restrict: 'EA',
            replace: true,
            templateUrl: 'js/lib/custom/angular-ui-datepicker/day.html',
            require: '^datepicker',
...
.directive('monthpicker', ['dateFilter',
    function(dateFilter) {
        return {
            restrict: 'EA',
            replace: true,
            templateUrl: 'js/lib/custom/angular-ui-datepicker/month.html',
            require: '^datepicker',
            link: function(scope, element, attrs, ctrl) {
                ctrl.step = {
                    years: 1
...
.directive('yearpicker', ['dateFilter',
    function(dateFilter) {
        return {
            restrict: 'EA',
            replace: true,
            templateUrl: 'js/lib/custom/angular-ui-datepicker/year.html',
            require: '^datepicker',
            link: function(scope, element, attrs, ctrl) {
...
.directive('datepickerPopupWrap', function() {
    return {
        ...
        replace: true,
        transclude: true,
        templateUrl: 'js/lib/custom/angular-ui-datepicker/popup.html',
