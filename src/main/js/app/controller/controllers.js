define(['reportsController', 'moduleWeekSelectorController', 'headerController', 'orgUnitContoller', 'loginController', 'opUnitController', 'aggregateModuleController',
    ...
    function(reportsController, moduleWeekSelectorController, headerController, orgUnitContoller, loginController, opUnitController, aggregateModuleController,
        ...
        var init = function(app) {
            ...
            app.controller('aggregateDataEntryController', ['$scope', '$routeParams', '$q', '$hustle', '$anchorScroll', '$location', '$modal', '$rootScope', '$window', '$timeout', 'dataRepository', 'excludedDataElementsRepository', 'approvalDataRepository', 'orgUnitRepository', 'dataSetRepository', 'programRepository', 'referralLocationsRepository', 'translationsService', 'moduleDataBlockFactory', 'dataSyncFailureRepository', 'optionSetRepository', aggregateDataEntryController]);
            ...
            app.controller('lineListDataEntryController', ['$scope', '$rootScope', '$routeParams', '$location', '$anchorScroll', 'historyService','programEventRepository', 'optionSetRepository', 'orgUnitRepository', 'excludedDataElementsRepository', 'programRepository', 'excludedLineListOptionsRepository', 'translationsService', lineListDataEntryController]);
            ...
            app.controller('lineListModuleController', ['$scope', '$hustle', 'orgUnitRepository', 'excludedDataElementsRepository', '$q', '$modal', 'programRepository', 'orgUnitGroupHelper', 'dataSetRepository', 'originOrgunitCreator', 'translationsService', 'excludedLineListOptionsRepository', lineListModuleController]);
