define(['dashboardController', 'dataEntryController', 'mainController', 'orgUnitContoller', 'loginController', 'opUnitController', 'moduleController', 'projectController', 'countryController', 'confirmDialogController',
    ...
    function(dashboardController, dataEntryController, mainController, orgUnitContoller, loginController, opUnitController, moduleController, projectController, countryController, confirmDialogController,
        ...
        var init = function(app) {
            ...
            app.controller('opUnitController', ['$scope', '$hustle', 'orgUnitService', 'orgUnitRepository', '$indexedDB', '$location', opUnitController]);
            app.controller('moduleController', ['$scope', '$hustle', 'orgUnitService', 'orgUnitRepository', 'dataSetRepository', '$indexedDB', '$location', '$q', moduleController]);
            app.controller('projectController', ['$scope', '$hustle', 'orgUnitService', 'orgUnitRepository', '$q', '$location', '$timeout', '$anchorScroll', 'userService', '$modal', projectController]);
            ...
            app.controller('countryController', ['$scope', '$hustle', 'orgUnitService', 'orgUnitRepository', '$q', '$location', '$timeout', '$anchorScroll', countryController]);
