define(["properties"], function(properties) {
    ...
    return {
        ...
        "getProgramsAndStages": with_host("/api/programs.json?fields=id,name,displayName,organisationUnits,attributeValues,programStages[id,name,programStageSections[id,name,programStageDataElements[id,compulsory,dataElement[id,name]]]]&paging=false"),
