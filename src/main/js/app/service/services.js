define(["metadataService", "filesystemService", "dataSetService", "programService", "orgUnitService", "systemSettingService", "historyService", "storageService", "metadataDownloader", "systemInfoService"],
    ...
    var init = function(app) {
        ...
        app.service('metadataDownloader', ['$http', '$q', 'changeLogRepository', 'metadataRepository', 'orgUnitGroupRepository', 'dataSetRepository', 'programRepository', 'systemSettingRepository', 'orgUnitRepository', 'customAttributeRepository', metadataDownloader]);
    };
    return {
        init: init
    };
