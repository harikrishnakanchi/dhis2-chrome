define(["approvalHelper", "angularMocks", "approvalDataRepository", "utils", "moment", "lodash"], function(ApprovalHelper, mocks, ApprovalDataRepository, utils, moment, _) {
    describe("approval helper", function() {
        var hustle, approvalDataRepository, q, approvalHelper, scope;
        ...
        beforeEach(mocks.inject(function($hustle, $q, $rootScope) {
            ...
            approvalHelper = new ApprovalHelper(hustle, approvalDataRepository);
        }));
