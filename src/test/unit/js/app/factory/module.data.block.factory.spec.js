    ...
    function (ModuleDataBlockFactory, OrgUnitRepository, DataRepository, ProgramEventRepository, ApprovalDataRepository, DataSyncFailureRepository, ModuleDataBlock, utils, mocks) {
        ...
        describe('ModuleDataBlockFactory', function() {
            ...
            describe('createForModule', function() {
                ...
                it("should call ModuleDataBlock.create with the orgUnit's parent", function () {
                    var moduleId = 'someModuleId',
                        moduleOrgUnit = {
                    ...
                    orgUnitRepository.findAll.and.returnValue(utils.getPromise(q, [moduleOrgUnit]));
                    orgUnitRepository.get.and.returnValue(utils.getPromise(q, parentOrgUnit));

                    periodRange = ['somePeriod'];
                    ...
                    expect(orgUnitRepository.get.calls.argsFor(0)[0]).toEqual(moduleOrgUnit.parentId);
                    expect(ModuleDataBlock.create).toHaveBeenCalledWith(moduleOrgUnit, 'somePeriod', [], [], {}, {}, parentOrgUnit);
                });
            });
