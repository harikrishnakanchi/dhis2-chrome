    ...
    function(AppCloneController, mocks, utils, timecop, FilesystemService, IndexeddbUtils, SessionHelper, indexedDBLogger) {
        describe("appCloneController", function() {
            ...
            it("should clone the entire indexed db successfully and save it to a file", function() {
                ...
                expect(filesystemService.writeFile).toHaveBeenCalledWith('dhis_idb_20140530-124354.zip', jasmine.any(Blob));
            });
            ...
            it("should dump logs to a file", function() {
                ...
                expect(filesystemService.writeFile).toHaveBeenCalledWith('logs_dump_20140530-124354.zip', jasmine.any(Blob));
            });
        });
    });
