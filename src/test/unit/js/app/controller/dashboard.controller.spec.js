define(["dashboardController", "angularMocks", "utils", "approvalHelper", "filesystemService", "indexeddbUtils", "timecop", "sessionHelper", "md5", "moment", "indexedDBLogger", "approvalDataRepository", "lodash"],
    function(DashboardController, mocks, utils, ApprovalHelper, FilesystemService, IndexeddbUtils, timecop, SessionHelper, md5, moment, indexedDBLogger, ApprovalDataRepository, _) {
        describe("dashboard controller", function() {
            var q, rootScope, db, hustle, dashboardController, approvalHelper, fakeModal, timeout, filesystemService, indexeddbUtils, idbDump, sessionHelper, location;
            ...
            beforeEach(mocks.inject(function($rootScope, $q, $hustle, $timeout, $location) {
                ...
                dashboardController = new DashboardController(scope, hustle, q, rootScope, approvalHelper, fakeModal, timeout, indexeddbUtils, filesystemService, sessionHelper, location, approvalDataRepository);
            }));
